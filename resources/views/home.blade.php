                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="#">
                            <img src="{{asset('images/usa.png')}}" alt="" class="img-fluid">
                        </a>
                    </li>
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="#">
                            <img src="{{asset('images/japan.png')}}" alt="" class="img-fluid">
                        </a>
                    </li>
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="#">
                            <img src="{{asset('images/korea.png')}}" alt="" class="img-fluid">
                        </a>
                    </li>
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="#">
                            <img src="{{asset('images/china.png')}}" alt="" class="img-fluid">
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Seo Bae Joo</span>
                    ...
                    <div class="col-xl-5 col-lg-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Sponsor Tree</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; KDP Market 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
