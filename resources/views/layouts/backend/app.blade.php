                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item no-arrow mx-1">
                            <a class="nav-link" href="#">
                                <img src="{{asset('storage/images/usa.png')}}" alt="" class="img-fluid">
                            </a>
                        </li>
                        <li class="nav-item no-arrow mx-1">
                            <a class="nav-link" href="#">
                                <img src="{{asset('storage/images/japan.png')}}" alt="" class="img-fluid">
                            </a>
                        </li>
                        <li class="nav-item no-arrow mx-1">
                            <a class="nav-link" href="#">
                                <img src="{{asset('storage/images/korea.png')}}" alt="" class="img-fluid">
                            </a>
                        </li>
                        <li class="nav-item no-arrow mx-1">
                            <a class="nav-link" href="#">
                                <img src="{{asset('storage/images/china.png')}}" alt="" class="img-fluid">
                            </a>
                        </li>
